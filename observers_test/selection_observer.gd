...
#	input_component.mouseClick.connect(on_mouse_click)
	...
	for player in player_team.get_players():
		...
		player.ui_component.action_menu_component.is_activated.connect(on_action_menu_player_activated)
		player.ui_component.action_menu_component.is_deactivated.connect(on_action_menu_player_deactivated)
