...
@export var stand_firm_check_button:CheckButton
@export var dodge_check_button:CheckButton
...
func clear():
	...
	stand_firm_check_button.button_pressed = false
	dodge_check_button.button_pressed = false
